...
#     import dexnet.api
#     dnobj = dexnet.api.DexNet()
#     dnobj.default_config = consts.CONFIG
#     dnobj.open_database(consts.CACHE_DIR + '/db.hdf5')
#     dnobj.open_dataset('ds')
#     dnobj.add_object(filepath)
#     
#     graspable = dnobj.dataset[mesh_id]
#     try:
#         stable_poses = dnobj.get_stable_poses(mesh_id)
#     except KeyError:
#         stable_poses = []
